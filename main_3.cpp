...

{
    ...
    initialize(end_time, queue_limit, arrival_rate, departure_rate, 3);
    Random variable;
    ...
    {                                                         //  loop over time intervals
        ...
        Plane moving_plane1, moving_plane2;
        switch (small_airport.activity_landing_secured(current_time, moving_plane1, moving_plane2))
        {
        ...
        case take_off_2_planes:
            moving_plane1.fly(current_time);
            moving_plane2.fly(current_time);
            break;
        case idle:
