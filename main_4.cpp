...

{
    ...
    initialize(end_time, queue_limit, arrival_rate, departure_rate, 4);
    Random variable;
    ...
    {                                                         //  loop over time intervals
        ...
        Plane moving_plane1, moving_plane2, moving_plane3;
        switch (small_airport.activity(current_time, moving_plane1, moving_plane2, moving_plane3))
        {
            //  Let two planes onto the Runway at current_time.
        case land:
            moving_plane1.land(current_time);
            break;
        case take_off:
        ...
        case land_2_planes:
            moving_plane1.land(current_time);
            moving_plane3.land(current_time);
            break;
        case take_off_2_planes:
            moving_plane2.fly(current_time);
            moving_plane3.fly(current_time);
            break;
        case land_2_planes_and_takeoff:
            moving_plane1.land(current_time);
            moving_plane2.fly(current_time);
            moving_plane3.land(current_time);
            break;
        case take_off_2_planes_and_land:
            moving_plane1.land(current_time);
            moving_plane2.fly(current_time);
            moving_plane3.fly(current_time);
            break;
